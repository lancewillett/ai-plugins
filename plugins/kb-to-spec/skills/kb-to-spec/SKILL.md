...
## The two-file model (the whole point)
...
### 1. Read source + learn the repo's spec convention
...
### 3. Build the spec (de-privatized + standalone)
...
### 4. MANDATORY privacy gate (before writing/committing)
